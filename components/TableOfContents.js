  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 rounded-full bg-zinc-900 text-white p-3 shadow-lg dark:bg-neutral-200 dark:text-black"
        ...
        {open && (
          <>
            ...
            <motion.aside
              ...
              className="fixed top-0 right-0 z-50 h-full w-[70%] sm:w-[60%] bg-neutral-800 dark:text-gray-400 dark:bg-transparent shadow-2xl overflow-y-auto p-5 rounded-l-2xl"
            >
              <div className="mb-3">
